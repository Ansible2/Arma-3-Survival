...
Examples:
   (begin example)
       _area = [marker] call CBAP_fnc_getArea;

       _area = [trigger] call CBAP_fnc_getArea;

       _area = [location] call CBAP_fnc_getArea;

       _area = [[center, a, b, angle, isRectangle]] call CBAP_fnc_getArea;
   (end)
