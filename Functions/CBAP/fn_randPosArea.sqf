...
Examples:
   (begin example)
       _position = [marker, true] call CBAP_fnc_randPosArea;
       _position = [trigger] call CBAP_fnc_randPosArea;
      _position = [location] call CBAP_fnc_randPosArea;
