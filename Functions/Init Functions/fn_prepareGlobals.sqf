...
BLWK_buildableObjects_array = [
    ...
    [25,   "Long Plank (8m)",      "Land_Plank_01_8m_F",                /*0,   4,*/ false, [0, [0,6,1]]      ],
    [50,   "Junk Barricade",       "Land_Barricade_01_4m_F",            /*0, 1.5,*/ false, [0, [0,4,0.5]]      ],
    [75,   "Small Ramp (1m)",      "Land_Obstacle_Ramp_F",            /*180, 1.5,*/ false, [180, [0,3,1]]    ],
    [85,   "Flat Triangle (1m)",   "Land_DomeDebris_01_hex_green_F",  /*180, 1.5,*/ false, [180, [0,3,0.75]]    ],
    [100,  "Short Sandbag Wall",   "Land_SandbagBarricade_01_half_F",   /*0, 1.5,*/ false, [0, [0,3,1]]      ],
    [150,  "Sandbag Barricade",    "Land_SandbagBarricade_01_hole_F",   /*0, 1.5,*/ false, [0, [0,3,1.5]]      ],
    [180,  "Concrete Shelter",     "Land_CncShelter_F",                 /*0,   1,*/ false, [0, [0,3,1.5]]      ],
    [200,  "Concrete Walkway",     "Land_GH_Platform_F",                /*0, 3.5,*/ false, [0, [0,6,0.75]]      ],
    [250,  "Tall Concrete Wall",   "Land_Mil_WallBig_4m_F",             /*0,   2,*/ false, [180, [0,4,2]]      ],
    [260,  "Portable Light",       "Land_PortableLight_double_F",     /*180,   1,*/ false, [180, [0,3,1.1]]    ],
    [300,  "Long Concrete Wall",   "Land_CncBarrierMedium4_F",          /*0,   3,*/ false, [0, [0.25,5,1.2]]      ],
    [400,  "Large Ramp",           "Land_VR_Slope_01_F",                /*0,   4,*/ false, [0, [0,9,2.25]]      ],
    [500,  "Bunker Block",         "Land_Bunker_01_blocks_3_F",         /*0,   2,*/ false, [0, [0,3,0.5]]      ], 
    [500,  "H Barrier",            "Land_HBarrier_3_F",                 /*0,   2,*/ false, [0, [0,4,1]]      ],
    [750,  "Ladder",               "Land_PierLadder_F",                 /*0,   1,*/ false, [0, [0.15,2.5,1]]      ],
    [800,  "Storage box small",    "Box_NATO_Support_F",                /*0,   1,*/ false, [90, [0,2,1]]      ],    
    [950,  "Stairs",               "Land_GH_Stairs_F",                /*180,   4,*/ false, [180, [0,5,1]]    ],
    [1000, "Hallogen Lamp",        "Land_LampHalogen_F",               /*90,   1,*/ false, [90, [0.2,2,2.75]]     ],
    [1000, "Double H Barrier",     "Land_HBarrierWall4_F",              /*0,   4,*/ false, [0, [0,5,1]]      ],   
    [1000, "Concrete Platform",    "BlockConcrete_F",                   /*0, 3.5,*/ false, [0, [0,8,0.5]]      ],
    [1200, "Storage box large",    "Box_NATO_AmmoVeh_F",                /*0,   1,*/ false, [0, [0,3,1]]      ],
    [2500, "Static HMG",           "B_HMG_01_high_F",                   /*0,   1,*/ false, [0, [0.25,2,2]]      ],
    [3000, "Small Bunker",         "Land_BagBunker_Small_F",          /*180,   3,*/ false, [180, [0,4,1]]    ],
    [4500, "Pillbox",              "Land_PillboxBunker_01_hex_F",      /*90, 2.5,*/ false, [90, [0,4,1]]     ],
    [6000, "Guard Tower",          "Land_Cargo_Patrol_V3_F",            /*0, 3.5,*/ false, [180, [0,6,5]]      ],
    [7500, "Autonomous HMG",       "B_HMG_01_A_F",                    /*180, 3.5,*/  true, [180, [0.25,2,2]]    ],
    [9500, "Modular Bunker",       "Land_Bunker_01_Small_F",          /*180, 3.5,*/ false, [180, [0.5,6,0]]    ]
];
