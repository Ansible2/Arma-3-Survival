...
BLWK_supports_array = [
    ...
    [2000, TO_STRING(CRUISE_MISSILE_CLASS)],
    // artillery
    [1500, TO_STRING(ARTILLERY_STRIKE_155MM_HE_CLASS)],
    [1500, TO_STRING(ARTILLERY_STRIKE_155MM_CLUSTER_CLASS)],
    [700, TO_STRING(ARTILLERY_STRIKE_155MM_MINES_CLASS)],
    [700, TO_STRING(ARTILLERY_STRIKE_155MM_AT_MINES_CLASS)],
    // light mortar
    [500, TO_STRING(MORTAR_STRIKE_82MM_HE_CLASS)],
    [200, TO_STRING(MORTAR_STRIKE_82MM_SMOKE_CLASS)],
    [100, TO_STRING(MORTAR_STRIKE_82MM_FLARE_CLASS)],
    // ship gun
    [1000, TO_STRING(CANNON_120MM_HE_CLASS)],
    [1000, TO_STRING(CANNON_120MM_CLUSTER_CLASS)],
    [500, TO_STRING(CANNON_120MM_AT_MINES_CLASS)],
    [500, TO_STRING(CANNON_120MM_MINES_CLASS)],
    [400, TO_STRING(CANNON_120MM_SMOKE_CLASS)],
    // supply
    [1000, TO_STRING(SUPPLY_ARSENAL_DROP_CLASS)],
    // CAS
