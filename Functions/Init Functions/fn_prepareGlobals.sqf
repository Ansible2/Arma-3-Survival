...
BLWK_supports_array = [
    ...
    // light mortar
    [600, TO_STRING(MORTAR_STRIKE_82MM_HE_CLASS)],
    ...
    [1000, TO_STRING(CANNON_120MM_AT_MINES_CLASS)],
    [1000, TO_STRING(CANNON_120MM_MINES_CLASS)],
    [1000, TO_STRING(CANNON_120MM_SMOKE_CLASS)]
];
