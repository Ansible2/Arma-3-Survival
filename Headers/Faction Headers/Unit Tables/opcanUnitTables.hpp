...
[ \
	...
	["LM_OPCAN_Meerkat_CGC_HMG","LM_OPCAN_ARV_CMA_HMG_WDL","LM_OPCAN_AFV102_AR_WDL","LM_OPCAN_M808_AR_WDL","LM_OPCAN_D77_U_CGC","LM_OPCAN_D77_U_CGC","","LM_OPCAN_UH101_CGC",""]\
]

#define OPCAN_ARMY_D_UNITS \
[ \
    ...
    "LM_OPCAN_UNSCA_Assaultman_DES", \
	["LM_OPCAN_HOG_MG_AR_DES","LM_OPCAN_ARV_CMA_HMG_WDL","LM_OPCAN_AFV102_AR_DES","LM_OPCAN_M808_AR_DES","LM_OPCAN_D77_U_AR_DES","LM_OPCAN_D77_U_AR_DES","","OPTRE_AV22C_Sparrowhawk",""]\
]

#define OPCAN_ARMY_WDL_UNITS \
[ \
	...
	["LM_OPCAN_HOG_MG_AR_WDL","LM_OPCAN_ARV_CMA_HMG_WDL","LM_OPCAN_AFV102_AR_WDL","LM_OPCAN_M808_AR_WDL","LM_OPCAN_D77_U_AR_WDL","LM_OPCAN_D77_U_AR_WDL","","OPTRE_AV22C_Sparrowhawk",""]\
]

#define OPCAN_MARINE_CEA_UNITS \
[ \
	...
	["LM_OPCAN_HOG_MG_MC_WDL","LM_OPCAN_ARV_CMA_HMG_WDL","LM_OPCAN_MGS_MC_WDL","LM_OPCAN_M808_MC_WDL","LM_OPCAN_D77_U_MC_WDL","LM_OPCAN_D77_U_MC_WDL","","OPTRE_AV22C_Sparrowhawk",""]\
]

#define OPCAN_MARINE_DES_UNITS \
[ \
...
[ \
	...
	"LM_OPCAN_URA_SL", \
	"LM_OPCAN_URA_TL", \
	["OPTRE_M12_LRV_ins","LM_OPCAN_ARV_CMA_HMG_WDL","I_E_APC_tracked_03_cannon_F","LM_OPCAN_M350_INS_WDL","LM_OPCAN_D77_U_FRI","LM_OPCAN_D77_U_FRI","","LM_OPCAN_UH101_FRI",""]\
]

#define OPCAN_SU_UNITS \
[ \
	...
	["LM_OPCAN_Rake_SU_HMG","LM_OPCAN_ARV_CMA_HMG_WDL","LM_OPCAN_Fox_SU","LM_OPCAN_M808_AR_DES","LM_OPCAN_D77_U_SU","LM_OPCAN_D77_U_SU","","LM_OPCAN_UH101_SU",""]\
]

#define OPCAN_KOSLOVICS_UNITS \
[ \
	"LM_OPCAN_KOS_Breacher", \
	"LM_OPCAN_KOS_Medic", \
	"LM_OPCAN_KOS_Engineer", \
	"LM_OPCAN_KOS_GL", \
	"LM_OPCAN_KOS_Marksman", \
	"LM_OPCAN_KOS_Officer", \
	"LM_OPCAN_KOS_Rifleman", \
	"LM_OPCAN_KOS_Rifleman_AT", \
	"LM_OPCAN_KOS_RTO", \
	"LM_OPCAN_KOS_SL", \
	"LM_OPCAN_KOS_TL", \
	"LM_OPCAN_KOS_AutoRifleman", \
	["LM_OPCAN_Meerkat_KOS_HMG","LM_OPCAN_ARV_CMA_HMG_WDL","I_E_APC_tracked_03_cannon_F","LM_OPCAN_MBTB_KOS","LM_OPCAN_D77_U_FRI","LM_OPCAN_D77_U_FRI","","LM_OPCAN_AV92_KOS",""]\
]

#define OPCAN_FRIDENS_WDL_UNITS \
[ \
	...
	["LM_OPCAN_Rake_FRI_AT","LM_OPCAN_Rake_FRI_HMG","I_APC_Wheeled_03_cannon_F","LM_OPCAN_M350_FRI","LM_OPCAN_D77_U_FRI","LM_OPCAN_D77_U_FRI","","LM_OPCAN_UH101_FRI",""]\
]

#define OPCAN_FRIDENS_DES_UNITS \
[ \
...
[ \
	...
	"LM_OPCAN_CMA_SL", \
	"LM_OPCAN_CMA_TL", \
	["LM_OPCAN_HOG_MG_CMA_WDL","LM_OPCAN_ARV_CMA_HMG_WDL","I_E_APC_tracked_03_cannon_F","B_T_MBT_01_cannon_F","LM_OPCAN_D77_U_CGC","LM_OPCAN_D77_U_CGC","","LM_OPCAN_UH101_CGC",""]\
]
